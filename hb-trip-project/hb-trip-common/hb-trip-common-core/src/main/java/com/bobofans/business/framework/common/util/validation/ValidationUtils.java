 ...
 */
package com.bobofans.business.framework.common.util.validation;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;

import com.bobofans.business.framework.common.util.string.StrUtils;
...
public class ValidationUtils {
    ...
    public static boolean isMobile(String mobile) {
        return StrUtils.hasText(mobile)
                && PATTERN_MOBILE.matcher(mobile).matches();
    }

    public static boolean isURL(String url) {
        return StrUtils.hasText(url)
                && PATTERN_URL.matcher(url).matches();
    }

    public static boolean isXmlNCName(String str) {
        return StrUtils.hasText(str)
